...
<?php echo $this->Form->create('SalesPayment');?>
	<fieldset>
		<legend><?php __('Edit Sales Payment'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('SalesPayment.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('SalesPayment.id'))); ?></li>
