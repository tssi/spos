...
<div class="tab">
	...
	<div class="tab-content">
		...
		<div class="canteen form formNeat w100">
							...
							<div class="trans">
								...
								<div class="forPrepaid">
									...
									<div style="text-align:right;">
										<img src="/canteen/img/icons/book_open.png" id="PrepaidBookButton" style="display:none">					
									</div>
								</div>
								<div class="forCharge">
									<div>
			...
			<div id="PrepaidBookWrapper" class="w90 mCenter" style="display:none">
				<hr>
					...
					<div id="CustomWrapper" style="display:none">
						<div class="fLeft w50  classic soft">	
							<?php echo $this->Form->input('from',array('id'=>'PrepaidFromDate','class'=>'uiDatePicker ','label'=>'Date','placeholder'=>'From','disabled'=>'disabled'));?>
						</div>
						<div class="fRight w50  classic soft">	
							<?php echo $this->Form->input('to',array('id'=>'PrepaidToDate','class'=>'uiDatePicker ','label'=>false,'placeholder'=>'To','disabled'=>'disabled'));?>
						</div>
						<div class="fClear"></div>
					</div>
				<hr>
				<div id="PrepaidBookLoading"></div>
