...
<?php
	...
	echo $this->Html->script(array('ui/uiSmartTable','ui/uiCollapsible','form/formValidation','form/formNeat','record/recordDatagrid','ui/uiInputNumeric','biz/sales_return','ss/ssUtil', 'ui/uiSmartSearch'));
	...
	<div class="tab-content">
		...
		<div class="canteen form formNeat w100">
			<div class="wLong">
					...
					<div class="fLeft w50 " id="buyer_info"> 
						...
						<div class="classic soft forCash" style="margin-left: -80px;">
							<?php
							 ...
							 ?>
							<?php
								 //echo $this->Form->input('Sale.id',array('type'=>'text', 'label'=>'Trans ID', 'class'=>' w24'));
								// echo $this->Form->input('Sale.type',array('type'=>'text', 'label'=>'Trans Type', 'class'=>' w24'));
				...
				<div class="w50 classic soft">
					<div class="fLeft w50">
						<div class="fLeft w50">
							<?php echo $this->Form->label('Trans:');?>
						</div>
						<div class="fRight w50">
							<?php echo $this->Form->input('Sale.id',array('type'=>'text','placeholder'=>'No', 'label'=>false, 'class'=>' w98'));?>
						</div>
						<div class="fClear"></div>
					...
					<div class="fRight w50">
						<div class="fLeft w50">
							<?php echo $this->Form->input('Sale.type',array('type'=>'text','placeholder'=>'Type', 'label'=>false, 'class'=>'w98 '));?>
						</div>
						<div class="fRight w50">
							<?php echo $this->Form->input('Sale.date',array('type'=>'text','placeholder'=>'Date',  'label'=>false, 'class'=>'w98 '));?>
						</div>
						<div class="fClear"></div>
					</div>
					<div class="fClear"></div>
						...
						<div class="fLeft w100 metro soft">
							<div class="wrapper">
								<div class="fLeft  w100 ">
									...
									<div class="fRight w75"><?php echo $this->Form->input('description', array('id'=>'description','class'=>'uiSmartSearch','search-on'=>'#counterItems ul.recordDataGrid li.clickInput')); ?></div>
									<div class="fClear"></div>
								</div>
								<div class="fClear"></div>							
							</div>
