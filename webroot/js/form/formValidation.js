...
$(document).ready(function(){
	...
	$('input, select').livequery(function(){
		$(this).bind('validate',function(e,param){
			...
			switch(param.status){
				case 1:
					mrk_up = '<span class="message"><img src="'+BASE_URL+'img/icons/tick.png" /><span>';
					break;
				case -1:
					msg = param.msg!=""?param.msg:'Invalid';
					mrk_up = '<div class="error-message message"><img src="'+BASE_URL+'img/icons/cross.png" />'+msg+'</div>';
					break;
				case 0 :
					msg = param.msg!=""?param.msg:'Checking...';
					mrk_up = '<span class="message"><img src="'+BASE_URL+'img/icons/loader.gif"  height="16px"/>'+msg+'<span>';
					break;
	...
	$(".required select").live('blur',function(){
